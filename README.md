...
საბოლოოდ შევარჩიე შედარებით მარტივი მოდელი რომელიც კარგად მუშაობდა: ordinal_target_42. მართალია სხვა მოდელები ტენინგისა და ტესტის დროს საკმაოდ კარგ შედეგებს აჩვენებდა, მაგრამ რეალობაში არც ისეთი კარგი მოდელები აღმოჩნდნენ, როგორიც ეს. დიდი რაოდენობით ცვლადს რომელიც მოიხმარდა overfit-ს აკეთებდა სატრეინინგო დატაზე და ამიტომ აღარ მუშაობდა კარგად სინამდვილეში. როდესაც ზევით უფრო კომპლექსური მოდელების შედეგები იყო 0.5, ამისი იყო დაახლოებით 0.3
...
* `MSE_test` - Mean Squared Error (ტესტზე)
...
* `MSE_test`    1378871651.2311795
* `MSE_train`   1206631886.4464383
* `RMSE_test`   36512.612024101545
* `RMSE_train`  34688.45746855058
* `MAE_test`    22672.087097970856
* `MAE_train`   22021.122616789908
* `R2_test`     0.7769732863656071
* `R2_train`    0.8084037937090116
* `MedAE_test`  16205.825232926316
* `MedAE_train` 15996.904241454095
* `EV_test`     0.7780337780131724
* `EV_train`    0.8084037937090116

საბოლოო შეფასება:   0.34081

P.S. ეს პროექტი vscode-ში გავაკეთე და მაგის გამო არ არის ზევით kaggle-ის იმპორტები 